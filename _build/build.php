...
class QuizPackage
{
    ...
    public function __construct($core_path, array $config = [])
    {
        ...
        $component = '/components/' . $config['name_lower'] . '/';
        $assets = $root . 'assets' . $component;
        $core = $root . 'core' . $component;
...
$install = new QuizPackage(MODX_CORE_PATH, $config);
