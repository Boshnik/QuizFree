...
class QuizFieldValueSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param QuizFieldValue $source
     * @param QuizFieldValue $target
     * @param array $where
     */
    public function sort(QuizFieldValue $source, QuizFieldValue $target, $where = [])
    {
...
return 'QuizFieldValueSortProcessor';