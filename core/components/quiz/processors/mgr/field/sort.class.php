...
class QuizFieldSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param QuizField $source
     * @param QuizField $target
     * @param array $where
     */
    public function sort(QuizField $source, QuizField $target, $where = [])
    {
