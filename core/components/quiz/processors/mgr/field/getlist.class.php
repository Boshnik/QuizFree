...
class QuizFieldGetListProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareQueryBeforeCount(xPDOQuery $c)
    {
        $c->where([
            ...
            'step_id' => $this->properties['step_id'] ?? 0,
            'contact' => $this->properties['contact'] ?? 0,
        ]);
    ...
    public function prepareRow(xPDOObject $object)
    {
        ...
        $array['type_lexicon'] = $this->modx->lexicon($array['type']);
        $array['actions'] = [];
...
return 'QuizFieldGetListProcessor';