...
class QuizResultSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param QuizResult $source
     * @param QuizResult $target
     * @param array $where
     */
    public function sort(QuizResult $source, QuizResult $target, $where = [])
    {
...
return 'QuizResultSortProcessor';