...
class QuizStepSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param QuizStep $source
     * @param QuizStep $target
     * @param array $where
     */
    public function sort(QuizStep $source, QuizStep $target, $where = [])
    {
